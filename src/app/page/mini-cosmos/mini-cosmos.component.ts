...
@Component({
  selector: 'app-mini-cosmos',
  imports: [],
  templateUrl: './mini-cosmos.component.html',
  styleUrl: './mini-cosmos.component.scss'
})
export class MiniCosmosComponent implements AfterViewInit , OnDestroy {
  ...
  ngAfterViewInit(): void {
    this.canvas = document.getElementById('cosmosCanvas') as HTMLCanvasElement;
